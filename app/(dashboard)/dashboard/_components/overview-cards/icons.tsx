...
export function Reservations(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      ...
      <rect x={16} y={22} width={26} height={2} fill="#fff" />

      {/* Ganchos superiores */}
      <rect x={21} y={15} width={3} height={6} rx={1.5} fill="#fff" />
      <rect x={34} y={15} width={3} height={6} rx={1.5} fill="#fff" />

      {/* Check de reserva */}
      <path
        d="M24 31l3.5 3.5L34 28"
        stroke="#fff"
        strokeWidth={2}
        strokeLinecap="round"
...
export function Sales(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      {/* Fondo */}
      <circle cx={29} cy={29} r={29} fill="#3FD97F" />
      ...
      {/* Etiqueta */}
      <path
        d="M18 26l10-10h8a2 2 0 012 2v8L28 36a2 2 0 01-2.828 0L18 28.828A2 2 0 0118 26z"
        stroke="#fff"
        strokeWidth={2}
        fill="none"
        strokeLinejoin="round"
      ...
      {/* Orificio de la etiqueta */}
      <circle cx={32} cy={22} r={2} fill="#fff" />

      {/* Símbolo de venta */}
      <path
        d="M27.5 29c0-1 1-1.5 2-1.5s2 .5 2 1.5-1 1.5-2 1.5-2 .5-2 1.5 1 1.5 2 1.5 2-.5 2-1.5M29.5 26v10"
        stroke="#fff"
        strokeWidth={1.8}
        strokeLinecap="round"
      />
